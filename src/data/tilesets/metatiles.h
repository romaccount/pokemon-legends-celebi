...
const u16 gMetatiles_CelebiPrimary[] = INCBIN_U16("data/tilesets/primary/celebi_primary/metatiles.bin");
const u16 gMetatileAttributes_CelebiPrimary[] = INCBIN_U16("data/tilesets/primary/celebi_primary/metatile_attributes.bin");
